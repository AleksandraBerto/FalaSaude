        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-2 border-b border-[#e5eeff]">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-[#ffffff] hover:bg-[#eff4ff] text-[#006a61] border border-[#d3e4fe] transition-colors shadow-xs font-semibold text-[12px] cursor-pointer"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-[#eff4ff] hover:bg-[#e5eeff] text-[#006a61] border border-[#d3e4fe] transition-colors font-semibold text-[12px] cursor-pointer"
            >
            ...
            <button
              onClick={handlePrint}
              className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-[#006a61] text-white hover:bg-[#005049] transition-all shadow-sm font-bold text-[12px] cursor-pointer"
            >
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            <div className="bg-[#ffffff] rounded-2xl p-5 border border-[#e5eeff] shadow-xs flex flex-col gap-4">
              ...
              <button
                ...
                className="w-full py-2.5 bg-[#eff4ff] hover:bg-[#e5eeff] text-[#006a61] font-bold text-[12px] rounded-xl transition-colors flex items-center justify-center gap-1.5 cursor-pointer mt-1"
              >
                <span className="material-symbols-outlined text-[16px]">arrow_back</span>
                Finalizar Consulta & Voltar à Fila do Plantão
              </button>
            </div>
          </div>
        </div>
