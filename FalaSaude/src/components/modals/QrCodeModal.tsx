    ...
    <div className="fixed inset-0 z-50 bg-[#131b2e]/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-[#ffffff] rounded-2xl max-w-md w-full p-6 flex flex-col gap-5 shadow-2xl relative border border-[#e5eeff]">
        ...
        <div className="flex flex-col items-center text-center gap-1.5 pt-2">
          <div className="w-12 h-12 rounded-xl bg-[#86f2e4] text-[#006f66] flex items-center justify-center mb-1 shadow-xs">
        ...
        <div className="flex flex-col items-center justify-center p-6 bg-[#eff4ff]/60 rounded-xl border border-[#d3e4fe]">
          <svg className="w-48 h-48 text-[#0b1c30]" viewBox="0 0 160 160" fill="currentColor">
            ...
            <rect x="60" y="60" width="40" height="40" rx="3" fill="#006a61" />
            <circle cx="80" cy="80" r="10" fill="#86f2e4" />
          ...
          <span className="mt-3 text-[11px] font-mono text-[#006a61] font-semibold flex items-center gap-1">
        ...
        <div className="bg-[#eff4ff]/40 p-3 rounded-xl border border-[#e5eeff] flex flex-col gap-1 text-[11px]">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-mono text-[#006a61]">ICP-Brasil A3 (SHA-256)</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 pt-1">
          <button
            onClick={handleCopy}
            className="flex-1 py-2 bg-[#eff4ff] hover:bg-[#e5eeff] text-[#006a61] rounded-lg font-semibold text-[12px] transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
          >
          ...
          <button
            onClick={onClose}
            className="px-5 py-2 bg-[#006a61] hover:bg-[#005049] text-white rounded-lg font-semibold text-[12px] transition-colors cursor-pointer"
          >
            Fechar
          </button>
        </div>
