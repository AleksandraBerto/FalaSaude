      ...
      <div className="bg-[#ffffff] rounded-2xl max-w-md w-full p-6 flex flex-col gap-4 shadow-2xl relative border border-[#e5eeff] text-center">
        ...
        <div className="flex justify-center items-center py-2">
          <div className="relative flex items-center justify-center">
            <span
              className={`absolute w-20 h-20 rounded-full bg-[#86f2e4] opacity-30 transition-transform duration-500 ${
                pulse === 1 ? 'scale-100' : pulse === 2 ? 'scale-125' : 'scale-150'
              }`}
            ></span>
            <div className="w-14 h-14 rounded-2xl bg-[#006a61] text-white flex items-center justify-center shadow-lg relative z-10">
        ...
        <div className="bg-[#eff4ff] p-4 rounded-xl border border-[#d3e4fe] flex flex-col gap-2 text-left">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[12px] font-bold text-[#006a61]">{patient.room}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-[11px] text-[#76777d] font-mono">Classificação:</span>
            <span className="text-[11px] font-bold capitalize text-[#0b1c30]">{patient.triageLabel}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-[11px] text-[#76777d] font-mono">Queixa:</span>
            <span className="text-[11px] text-[#45464d] truncate max-w-[220px]">{patient.chiefComplaint}</span>
          </div>
        </div>

        <div className="p-3 bg-[#f8f9ff] rounded-lg border border-[#e5eeff] text-[11px] text-[#45464d] italic">
          "Atenção: Paciente {patient.name}, favor dirigir-se ao {patient.room} com Dr. Renato Guimarães."
        </div>
        ...
        <div className="flex items-center gap-2 pt-2">
          ...
          <button
            ...
            className="flex-1 py-2 bg-[#006a61] hover:bg-[#005049] text-white rounded-lg text-[12px] font-bold transition-all shadow-sm flex items-center justify-center gap-1.5 cursor-pointer"
          >
