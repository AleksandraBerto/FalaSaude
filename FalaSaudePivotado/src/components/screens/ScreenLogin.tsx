    ...
    <div className="min-h-screen bg-gradient-to-br from-[#eff4ff] via-[#f8f9ff] to-[#e6f4f2] flex flex-col justify-between p-4 sm:p-6 font-sans">
      ...
      <div className="max-w-md w-full mx-auto my-auto bg-white rounded-3xl shadow-xl shadow-slate-200/60 border border-[#e5eeff] p-6 sm:p-8 animate-fadeIn">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <h2 className="text-xl font-bold text-[#0b1c30]">Acesso ao Plantão</h2>
          <p className="text-xs text-[#76777d] mt-1">
            Pronto-Socorro & Assistente Clínico Auditável
          </p>
        </div>

        {/* Quick User Selection Dropdown (Menu Suspenso de Usuários) */}
        <div className="mb-5 p-3 rounded-2xl bg-[#f0fdf4] border border-[#bbf7d0]">
          <label className="block text-[11px] font-semibold text-[#166534] uppercase tracking-wider mb-1.5 flex items-center justify-between">
            <span className="flex items-center gap-1">
              <span className="material-symbols-outlined text-[14px]">badge</span>
              Médico Plantonista
            </span>
            <span className="text-[10px] bg-white px-2 py-0.5 rounded-full border border-[#bbf7d0] text-[#166534] font-mono">
              3 perfis
            </span>
          </label>
          <div className="relative">
            <select
              ...
              className="w-full bg-white text-[#0b1c30] text-xs font-medium rounded-xl border border-[#bbf7d0] py-2.5 pl-3 pr-8 focus:outline-none focus:ring-2 focus:ring-[#16a34a] transition-all cursor-pointer appearance-none shadow-xs"
            >
            ...
            <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2.5 text-[#166534]">
              <span className="material-symbols-outlined text-[18px]">expand_more</span>
            </div>
          </div>
          <div className="mt-2 flex items-center justify-between text-[11px] text-[#166534]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="nome.doutor@falasaude.med.br"
                className="w-full pl-10 pr-3 py-2.5 text-xs text-[#0b1c30] bg-[#f8f9ff] border border-[#d3e4fe] rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#006a61] transition-all shadow-xs"
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                ...
                className="text-[11px] text-[#006a61] hover:text-[#005049] hover:underline font-medium cursor-pointer"
              >
                Esqueci a senha
              </button>
            </div>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 text-xs text-[#0b1c30] bg-[#f8f9ff] border border-[#d3e4fe] rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#006a61] transition-all shadow-xs"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full mt-2 py-3 bg-[#006a61] hover:bg-[#005049] text-white rounded-xl text-xs font-bold transition-all shadow-md shadow-[#006a61]/20 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-75"
          >
            {isLoading ? (
              <>
                <span className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></span>
                <span>Autenticando Plantão...</span>
              </>
            ) : (
              <>
      ...
      {showForgotModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs animate-fadeIn">
          <div className="bg-white rounded-2xl max-w-sm w-full p-5 shadow-2xl border border-[#e5eeff] flex flex-col gap-3">
            ...
            <div className="bg-[#eff4ff] p-3 rounded-xl border border-[#d3e4fe] text-xs font-mono text-[#006a61] flex flex-col gap-1">
            ...
            <button
              onClick={() => setShowForgotModal(false)}
              className="mt-2 w-full py-2 bg-[#006a61] hover:bg-[#005049] text-white rounded-xl text-xs font-semibold cursor-pointer"
            >
              Entendido
            </button>
          </div>
