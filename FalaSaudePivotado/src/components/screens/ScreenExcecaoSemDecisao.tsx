    ...
    <main className="w-full pt-24 pb-32 bg-[#f8f9ff] min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col gap-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-[#e5eeff]">
          ...
          <div className="flex items-center gap-2">
            <span className="px-3 py-1 rounded-full bg-[#eff4ff] border border-[#d3e4fe] text-[#006a61] text-[11px] font-mono font-semibold flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-[#ca8a04]"></span>
              {currentPatient.name} • Protocolo de Consulta Neutra
            </span>
          </div>
        </div>
      ...
      {/* Sticky Bottom Action Bar - Passo 5 */}
        ...
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                <span className="font-bold text-[#0b1c30] text-[13px]">
                  Salvaguarda Anti-Alucinação Ativa
                </span>
              ...
              <p className="text-[11px] text-[#76777d]">
                Art. 3º Resolução CFM 2.314/22: Nenhuma conduta ou exame foi presumido artificialmente pela IA.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end flex-wrap">
            ...
            >
              ...
              <span>Inserir Conduta Manual</span>
            </button>
            ...
            >
              ...
              <span>Confirmar Alta c/ Orientações</span>
            </button>

            <button
              onClick={() => onNavigate('fila-do-plantao')}
              className="px-5 py-2 bg-[#006a61] hover:bg-[#005049] text-white font-bold text-[12px] rounded-lg transition-all flex items-center gap-1.5 shadow-sm cursor-pointer"
            >
              <span className="material-symbols-outlined text-[16px]">arrow_back</span>
              <span>Voltar à Fila do Plantão</span>
            </button>
          </div>
        </div>
      </div>
